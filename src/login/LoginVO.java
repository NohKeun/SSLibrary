...
public class LoginVO { 
	...
	private String member_email_dm;
	...
	public String getMember_email_dm() {
		return member_email_dm;
	}

	public void setMember_email_dm(String member_email_DM) {
		this.member_email_dm = member_email_DM;
	}
